...
Total new coverage: 12 tests across 4 files. Full suite: **476 tests pass** (was 464 before this category).
...
Each test starts with a `// Mitigates:` block linking back to the audit finding (Set A) or to the Task 14 risk rationale (Set B). This is the structure the PRD asked for: "Each test must include a comment explaining what risk it mitigates."
